...
namespace CursoEFCore.Data
{
    public class ApplicationContext : DbContext
    {
        ...
        {
            optionsBuilder
                .UseLoggerFactory(_logger) // LOG UTILIZADO
                .EnableSensitiveDataLogging() // EXIBIR OS VALORES DOS PARAMETROS GERADOS NO SQL DO EF CORE
        ...
        private void MapearPropriedadesEsquecidas(ModelBuilder modelBuilder)
        {
            foreach(var entity in modelBuilder.Model.GetEntityTypes())
            {
                ...
                {
                    // TIPO DA COLUNA VAZIO OU NAO FOI INFORMADO PROPRIEDADE PARA ESSA COLUNA
